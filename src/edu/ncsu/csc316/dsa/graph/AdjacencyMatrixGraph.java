...
public class AdjacencyMatrixGraph<V, E> extends EdgeListGraph<V, E> {
    ...
    public Edge<E> insertEdge(Vertex<V> vertex1, Vertex<V> vertex2, E edgeData) {
    	...
    	GraphEdge newEdge = validate(e);
    	matrix[v1.getIndex()][v2.getIndex()] = newEdge;

    	if (!isDirected()) {
    		matrix[v2.getIndex()][v1.getIndex()] = newEdge;
    	}
    	return newEdge;
    }
    ...
    public void removeEdge(Edge<E> edge) {
        ...
        matrix[validate(e.getEndpoints()[0]).getIndex()][validate(e.getEndpoints()[1]).getIndex()] = null;
