...
public class AdjacencyListGraphTest {
    ...
    public void testEdges() {
        ...
        undirectedGraph.toString();
        Iterator<Edge<Integer>> it = undirectedGraph.edges().iterator();
        
        assertTrue(it.hasNext());
        assertEquals(e1, it.next());
        //java.lang.AssertionError: 
        //expected: edu.ncsu.csc316.dsa.graph.AdjacencyListGraph$ALEdge<Edge[element=5]> 
        //but was:  edu.ncsu.csc316.dsa.graph.AdjacencyListGraph$ALEdge<Edge[element=5]>
