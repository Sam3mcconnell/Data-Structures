...
public class QuickSorterTest {
	...
	@Test
	public void testSortIntegersFirstElementSelector() {
	
		Sorter<Integer> s = new QuickSorter<Integer>(QuickSorter.FIRST_ELEMENT_SELECTOR);
		Integer test1 = 1;
		Integer test2 = 2;
		Integer test3 = 3;
		Integer test4 = 4;
	...
	@Test
	public void testSortIntegersLastElementSelector() {
		Sorter<Integer> s = new QuickSorter<Integer>(QuickSorter.LAST_ELEMENT_SELECTOR);
		Integer test1 = 1;
		Integer test2 = 2;
		Integer test3 = 3;
		Integer test4 = 4;
	...
	@Test
	public void testSortIntegersMiddleElementSelector() {
		Sorter<Integer> s = new QuickSorter<Integer>(QuickSorter.MIDDLE_ELEMENT_SELECTOR);
		Integer test1 = 1;
		Integer test2 = 2;
		Integer test3 = 3;
		Integer test4 = 4;
	...
	public void testSortStudentID() {
		Sorter<Student> s = new QuickSorter<Student>(new StudentIDComparator());
	...
	public void testSortStudentGPA() {
		Sorter<Student> s = new QuickSorter<Student>(new StudentGPAComparator());
		Student sOne = new Student("OneFirst", "OneLast", 1, 1, 1.0, "oneUnityID");
